    ...
    class Fbi : Script
    {
        ...
        public static void interactPressed(Player player, int interact)
        {
            switch (interact)
            {
                case 20:
                    ...
                    else Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"You are not an employee FBI", 3000);
                    return;
                case 21:
                ...
                case 24:
                    if (Main.Players[player].FractionID != 9)
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"You are not an employee FBI", 3000);
                        return;
                    }
                ...
                case 46:
                    ...
                    if (player.GetData<bool>("IN_CP_MODE"))
                    {
                        ...
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"You changed into work uniform", 3000);
                    }
                    else
                    {
                        if (!warg_mode)
                        ...
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"You changed into a special. shape", 3000);
                    }
                    return;
                case 61:
                    if (Main.Players[player].FractionID != 9)
                    ...
                    GUI.Dashboard.OpenOut(player, Stocks.fracStocks[9].Weapons, "Open Stock", 6);
                    return;
            }
        }
        ...
        public static void callback_fbilift(Player client, int floor)
        {
            try
            {
                ...
                {
                    Notify.Send(client, NotifyType.Error, NotifyPosition.BottomCenter, $"Someone drags you along", 3000);
                    return;
                }
                switch (floor)
                {
            ...
            try
            {
                switch (index)
                {
                    ...
                    case 5:
                        ...
                        {
                            Notify.Send(client, NotifyType.Error, NotifyPosition.BottomCenter, "Not enough materials in stock", 3000);
                            return;
                        }
                    ...
                    case 11:
                        ...
                        {
                            Notify.Send(client, NotifyType.Error, NotifyPosition.BottomCenter, $"You already have a badge", 3000);
                            return;
                        }
                        ...
                        Notify.Send(client, NotifyType.Success, NotifyPosition.BottomCenter, $"You have received your FIB badge", 3000);
                        return;
                }
            }
